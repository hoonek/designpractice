...
class NewProgressUser extends StatefulWidget {
  const NewProgressUser({Key? key}) : super(key: key);

  @override
  _NewProgressUserState createState() => _NewProgressUserState();
}

class _NewProgressUserState extends State<NewProgressUser> {
